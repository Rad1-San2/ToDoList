...
if (isset($_POST["updateTodo"])) {
    ...
    // Updating todo
    $sql = "UPDATE todos SET title='{$title}', description='{$desc}', priority='{$priority}', date=CURRENT_TIMESTAMP WHERE id='{$todoId}'";
    $res = mysqli_query($conn, $sql);
    if ($res) {
        $_POST["title"] = "";
        $_POST["desc"] = "";
        $_POST["priorty"] = "";
        $msg = "<div class='alert alert-success'>To-Do is updated.</div>";
    } else {
        $msg = "<div class='alert alert-danger'>To-Do is not updated.</div>";
    }
}
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="e.g. Create a To-Do" value="<?php echo $todoData['title']; ?>" required>
                            </div>
                            <div class="mb-3">
